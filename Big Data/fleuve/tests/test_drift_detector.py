...
from drift_detector_master import DriftDetectorMaster
...
sc.addPyFile("/home/patryk_patrykwrona/repos/Fleuve/master/drift_detector.py")
sc.addPyFile("/home/patryk_patrykwrona/repos/Fleuve/master/drift_detector_handler.py")
...
sc.addPyFile("/home/patryk_patrykwrona/repos/Fleuve/master/predictor.py")
sc.addPyFile("/home/patryk_patrykwrona/repos/Fleuve/master/predictor_handler.py")
sc.addPyFile("/home/patryk_patrykwrona/repos/Fleuve/master/caching.py")

#SET TASK
task = {"cluster-9e14-w-0": {"detectors": [drift.KSWIN(), drift.ADWIN()] }, 
        "cluster-9e14-w-1" : {"detectors": [drift.ADWIN()] }, 
...
sm = DriftDetectorMaster(data_cols, task)
sm.transform_and_collect(sdf, "/user/hdfs/tescik", "/user/hdfs/tescik/chk")

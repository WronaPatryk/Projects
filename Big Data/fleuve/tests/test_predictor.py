...
from predictor_master import PredictorMaster
...
task = {"cluster-9e14-w-0": {"pretrained_models": ['ARFClassifier_cluster-9e14-w-0_223667.pkl','ARFClassifier_cluster-9e14-w-1_215236.pkl'], "scaler": preprocessing.StandardScaler()}, 
        "cluster-9e14-w-1" : {"pretrained_models": ['ARFClassifier_cluster-9e14-w-0_223667.pkl','ARFClassifier_cluster-9e14-w-1_215236.pkl'], "scaler": preprocessing.StandardScaler()}, 'workers': ["cluster-9e14-w-0", "cluster-9e14-w-1"]}
...
sm = PredictorMaster(data_cols, task)
